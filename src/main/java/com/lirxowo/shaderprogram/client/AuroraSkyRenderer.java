...
public class AuroraSkyRenderer {
    ...
    public static void render(RenderLevelStageEvent event) {
        boolean active = AuroraSkyEffect.isEnabled();
        ...
        if (active && !cloudsHidden) {
            ...
            // 仅当 synthwave 天空未激活时才恢复云设置
            boolean synthwaveActive = SynthwaveEffect.isEnabled() || SynthwaveEffect.getRadius() > 0.01f;
            if (!synthwaveActive && savedCloudStatus != null) {
        ...
        ShaderInstance shader = AuroraSkyShader.instance;
        ...
        // GameTime 是 Minecraft 内置 uniform，由 ShaderInstance.apply() 自动设置
        // 着色器中通过 GameTime * 1200.0 转换为秒
